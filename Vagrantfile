...
192.168.99.10 zabbix zabbix.wccs.com.br zabbix.xiriba.com.br
192.168.99.11 graylog graylog.xiriba.com.br
192.168.99.12 prometheus prometheus.xiriba.com.br
192.168.99.13 willtube willtube.xiriba.com.br" > /etc/hosts
    rm -rf /etc/resolv.conf
    echo "search xiriba.com.br
...
#XIRIBA
  config.vm.define "willtube" do |willtube|
    willtube.vm.hostname = "willtube"
    willtube.vm.box = "centos/7"
    willtube.vm.box_check_update = false
    willtube.vm.network "private_network", ip: "192.168.99.13", dns: "8.8.8.8"

  willtube.vm.provision "shell", inline: <<-SHELL
    sudo rpm -Uvh https://yum.puppet.com/puppet5/puppet5-release-el-7.noarch.rpm
    cd /root
